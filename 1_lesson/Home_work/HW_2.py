# 2. Петя, Катя и Сережа делают из бумаги журавликов. Вместе они сделали
...
n = int(input("Введите сумму журавликов: \n"))
boys = n / 6
girl = boys * 4
print(f"Петя и Сережа сделали по {boys} журавликов, Катя сделала {girl} журавликов")